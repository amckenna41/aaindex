...
The AAindex3 section contains 47 statistical protein contact potentials and follows the
same record format as AAindex2. Each entry stores a 20 × 20 matrix of pairwise contact
potential scores derived from statistical analysis of protein structures.
...
.. automodule:: aaindex.aaindex3
   :no-members:

.. autoclass:: aaindex.aaindex3.AAIndex3
