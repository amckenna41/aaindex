...
The documentation for `aaindex` is hosted on the **readthedocs** platform and is available [here](https://aaindex.readthedocs.io/en/latest). The documentation is automatically built and published on the platform via the repo. 
...
Create a /docs directory inside the `aaindex` package
```bash
mkdir /docs
```
